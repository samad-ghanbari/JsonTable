...
QJsonObject JsonTable::createStyle(double _width, double _height, QString _backgroundColor, QString _color, double _fontSize, bool _bold, bool _center, QString _fontFamily, int rowSpan)
{
    QJsonObject obj;
